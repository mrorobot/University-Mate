...
public class Addteacher extends JFrame implements ActionListener{
    ...
    JTextField tfname, tffname, tfaddress, tfphone,tfpname, tfemail, tfaadhar;
    JLabel labelrollno;
    JDateChooser dcdob;
    ...
    Addteacher() {
        ...
        lblpname.setBounds(50, 400, 200, 30);
        lblpname.setFont(new Font("serif", Font.BOLD, 20));
        add(lblpname);
        
        tfpname = new JTextField();
        tfpname.setBounds(200, 400, 150, 30);
        add(tfpname);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            String highestQualification = (String) cbcourse.getSelectedItem();
            String Department = (String) cbbranch.getSelectedItem();
            String pname = tfpname.getText();
            
            
            try {
                String query = "insert into teacher values('"+name+"', '"+fname+"', '"+EmpId+"', '"+dob+"', '"+address+"', '"+phone+"', '"+email+"','"+aadhar+"', '"+highestQualification+"', '"+Department+"', '"+pname+"')";
